...
@section('content')
    <div class="container">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">Edit Data Soal</div>
            ...
            <div class="panel-body">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama" name="nama" placeholder="Isikan Nama Anda" value="{{ $soals->nama }}" required>
              </div>
              <div class="form-group">
                  <label class="control-label" for="tempat_lahir">Tempat Lahir</label>
                  <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="{{ $soals->tempat_lahir }}" placeholder="Isikan Kota Anda Lahir">
              </div>
              <div class="form-group">
                  <label class="control-label" for="tanggal_lahir">Tanggal Lahir</label>
                  <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="{{ $soals->tanggal_lahir }}" required>
              </div>
              <div class="form-group">
                  <label class="control-label" for="asal_sekolah">Asal Sekolah</label>
                  <input type="text" class="form-control" id="asal_sekolah" name="asal_sekolah" value="{{ $soals->asal_sekolah }}" placeholder="Isikan Asal Sekolah Anda">
              </div>
              {{-- Select Option for Agama --}}
              <div class="form-group">
                  <label for="agama_id">Agama</label>
                  <select class="form-control" name="agama_id" id="agama_id" value="{{ $soals->agamas->deskripsi }}">
